...
CREATE TABLE IF NOT EXISTS `truckpad_db`.`Drivers` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_CNHType_idx` (`FK_CNHTypes` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `truckpad_db`.`Itineraries` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_Driver_idx` (`FK_Drivers` ASC) VISIBLE,
  INDEX `FK_TruckType_idx` (`FK_TruckType` ASC) VISIBLE,
  INDEX `FK_Origin_Addresses` (`FK_Dest_Addresses` ASC) VISIBLE,
  INDEX `FK_Dest_Addresses` (`FK_Origin_Addresses` ASC) VISIBLE,
